...
X=tf.compat.v1.placeholder(tf.float32,name='X',shape=[None,n_inputs])
Y=tf.compat.v1.placeholder(tf.float32,name='Y',shape=[None,n_classes])
pred=tf.compat.v1.placeholder(tf.float32,name='pred',shape=[None,n_classes])
pred = RNN(X, w, b)
